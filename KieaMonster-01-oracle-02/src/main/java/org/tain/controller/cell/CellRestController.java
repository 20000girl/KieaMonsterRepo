package org.tain.controller.cell;
...
import org.tain.repository.cell.CellRepository;
import org.tain.utils.CurrentInfo;

import lombok.extern.slf4j.Slf4j;

@RestController
@RequestMapping(value = {"/rest/cell"})
@Slf4j
public class CellRestController {
	...
	public ResponseEntity<?> list(HttpEntity<String> httpEntity) throws Exception {
		...
		List<Cell> list = this.cellRepository.findAll();
	...
	public List<Cell> list2() throws Exception {
		log.info("KANG-20210330 >>>>> {} {}", CurrentInfo.get());
